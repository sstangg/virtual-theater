...
public class WatchIndoorMovies extends JPanel implements IRefreshable {
    ...
    public WatchIndoorMovies(TheaterFrame frame) {
        super();
        this.frame = frame;
        ...
        titleMessage.setText("Indoor Movie Theater");
    ...
    public void refreshCache() {
        ...
        Movie movie = frame.getManager().getCurrentMovie(TheaterType.INDOOR, now);
