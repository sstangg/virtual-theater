...
public class WatchDriveinMovies extends JPanel implements IRefreshable {
    ...
    public WatchDriveinMovies(TheaterFrame frame) {
        super();
        this.frame = frame;
        ...
        titleMessage.setText("Drive-In Movie Theater");
    ...
    public void refreshCache() {
        ...
        Movie movie = frame.getManager().getCurrentMovie(TheaterType.DRIVEIN, now);
